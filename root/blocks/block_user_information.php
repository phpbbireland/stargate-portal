...
//MOD//$flag = 'images/flags/' . $user->data['user_country_flag'];
...
$template->assign_vars(array(
	...
	'AVATAR'            => sgp_get_user_avatar($user->data['user_avatar'], $user->data['user_avatar_type'], 90, 90),
	'USER_NAME'         => $user->data['username'],
	//MOD//'USER_COUNTRY_FLAG'	=> $flag,
...
$template->set_filenames(array(
	'body' => 'blocks/block_user_information.html',
	)
);
*/	 
?>