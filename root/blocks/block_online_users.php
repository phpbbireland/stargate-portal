...
*
* @version $Id: block_online_users.php 297 2008-12-30 18:40:30Z Michaelo $
...
if($this_page[0] == 'viewforum' || $this_page[0] == 'viewtopic' || $this_page[0] == 'search')
{
	...
	$template->assign_vars(array(
		...
		'OU_PORTAL_DEBUG'		=> sprintf($user->lang['PORTAL_DEBUG_QUERIES'], ($queries) ? $queries : '0', ($cached_queries) ? $cached_queries : '0', ($total_queries) ? $total_queries : '0'),
	));
}
else
{
