...
// query the database
if(!($result = $db->sql_query_limit($sql, (($number_of_announce_items_to_display) ? $number_of_announce_items_to_display : 1))))
{
	trigger_error("Could not query announcements information ", "", __LINE__, __FILE__, $sql);
}
...
$template->assign_vars(array(
	...
	'AN_PORTAL_DEBUG'					=> sprintf($user->lang['PORTAL_DEBUG_QUERIES'], ($queries) ? $queries : '0', ($cached_queries) ? $cached_queries : '0'),
));
