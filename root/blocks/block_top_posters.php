...
//$sql = 'SELECT user_id, username, user_posts, user_colour, user_type, group_id, user_avatar, user_avatar_type, user_avatar_width , user_avatar_height, user_website, user_country_flag
...
while($row = $db->sql_fetchrow($result))
{
    ...
    $template->assign_block_vars('top_posters', array(
		...
		//'COUNTRY_FLAG_IMG' =>  $row['user_country_flag'], 
