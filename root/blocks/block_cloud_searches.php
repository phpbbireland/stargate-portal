...
{
	//$link = 'search.php?search_keywords=' . $row['word_text'];
	...
	$cumuluscontent .= '<a href="' .  $link . '" ' . 'colour2="' .  $colour2 . '" ' . 'title="' . '" ' . 'rel="' . $rel . '" ' . 'style="font-size:' . $font_size . 'pt;"' . 'color="0x' . $colour . '" hicolor="0x' . $hcolour . '">' . $row['word_text'] . '</a>; ';
}
