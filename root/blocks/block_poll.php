...
*/
	...
	*/
	...
	$b_sort_dir	= request_var('sd', ((!empty($user->data['user_post_sortby_dir'])) ? $user->data['user_post_sortby_dir'] : 'a'));
	...
	*/
	...
	if (!empty($topic_data['poll_start']))
	{
		...
		else
		{
			...
			{
				$cur_voted_id = request_var($config['cookie_name'] . '_poll_' . $b_topic_id, 0, false, true);
